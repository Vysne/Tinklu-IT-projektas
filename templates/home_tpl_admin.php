...
<body>
    <div id="clientWrapper">
                ...
                <?php
                    foreach($saskaitos as $saskaita) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $saskaita["kliento_nr"]; ?></td>
        ...
        ?>
            <div id="adminActions">
                <a class="admin-buttons" href="home.php?action=naujasKlientas">Naujas Klientas</a>
                <a class="admin-buttons" href="home.php?action=naujaSaskaita">Nauja Sąskaita</a>
            </div>
        <?php
        }
        else {
        ?>
            <a class="logout-button" href="home.php">Atšaukti</a>
        <?php
            include $fileName;
        }
        ?>
